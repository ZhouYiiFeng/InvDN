...
class InvNet(nn.Module):
    def __init__(self, channel_in=3, channel_out=3, subnet_constructor=None, block_num=32, down_num=2):
...
def define_G(opt):
    ...
    netG = InvNet(opt_net['in_nc'], opt_net['out_nc'], subnet(subnet_type, init), 32, down_num)
